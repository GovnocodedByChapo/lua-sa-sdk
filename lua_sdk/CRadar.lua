...
return require('lua_sdk.loader')({
    ...
    -- __Generator.lua test:
    SetCoordBlipAppearance = {'void (__cdecl *)(int, unsigned char)', 0x583E50},
    SetBlipFriendly = {'void (__cdecl *)(int, unsigned char)', 0x583EB0},
    SetBlipEntryExit = {'void (__cdecl *)(int, CEntryExit*)', 0x583F00},
    ShowRadarTrace = {'void (__cdecl *)(float, float, unsigned int, unsigned char, unsigned char, unsigned char, unsigned char)', 0x583F40},
    ShowRadarTraceWithHeight = {'void (__cdecl *)(float, float, unsigned int, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char)', 0x584070},
    ShowRadarMarker = {'void (__cdecl *)(struct CVector, unsigned int, float)', 0x584480},
    DrawRotatingRadarSprite = {'void (__cdecl *)(CSprite2d*, float, float, float, unsigned int, unsigned int, CRGBA)', 0x584850},
    DrawYouAreHereSprite = {'void (__cdecl *)(float, float)', 0x584960},
    SetupRadarRect = {'void (__cdecl *)(int, int)', 0x584A80},
    RequestMapSection = {'void (__cdecl *)(int, int)', 0x584B50},
    RemoveMapSection = {'void (__cdecl *)(int, int)', 0x584BB0},
    RemoveRadarSections = {'void (__cdecl *)()', 0x584BF0},
    StreamRadarSections = {'void (__cdecl *)(int, int)', 0x584C50},
    DrawAreaOnRadar = {'void (__cdecl *)(CRect const&, CRGBA const&, bool)', 0x5853D0},
    DrawRadarMask = {'void (__cdecl *)()', 0x585700},
    StreamRadarSections_CVector = {'void (__cdecl *)(struct CVector)', 0x5858D0},
    Shutdown = {'void (__cdecl *)()', 0x585940},
    InitFrontEndMap = {'void (__cdecl *)()', 0x585960},
    AddBlipToLegendList = {'void (__cdecl *)(unsigned char, int)', 0x5859F0},
    SetMapCentreToPlayerCoords = {'void (__cdecl *)()', 0x585B20},
    Draw3dMarkers = {'void (__cdecl *)()', 0x585BF0},
    SetRadarMarkerState = {'void (__cdecl *)(int, unsigned char)', 0x585FE0},
    DrawRadarSprite = {'void (__cdecl *)(unsigned short, float, float, unsigned char)', 0x585FF0},
    DrawRadarSection = {'void (__cdecl *)(int, int)', 0x586110},
    DrawRadarSectionMap = {'void (__cdecl *)(int, int, CRect)', 0x586520},
    DrawRadarGangOverlay = {'void (__cdecl *)(bool)', 0x586650},
    DrawRadarMap = {'void (__cdecl *)()', 0x586880},
    DrawMap = {'void (__cdecl *)()', 0x586B00},
    DrawCoordBlip = {'void (__cdecl *)(int, unsigned char)', 0x586D60},
    DrawEntityBlip = {'void (__cdecl *)(int, unsigned char)', 0x587000},
    ClearActualBlip = {'void (__cdecl *)(int)', 0x587C10},
    ClearBlipForEntity = {'void (__cdecl *)(eBlipType, int)', 0x587C60},
    ClearBlip = {'void (__cdecl *)(int)', 0x587CE0},
    SetupAirstripBlips = {'void (__cdecl *)()', 0x587D20},
    Initialise = {'void (__cdecl *)()', 0x587FB0},
    DrawBlips = {'void (__cdecl *)()', 0x588050},
    Load = {'void(__cdecl *)()', 0x5D53C0},
    Save = {'void(__cdecl *)()', 0x5D5860}
}, {
    BLIP_FLAG_FRIEND = 0,
    BLIP_FLAG_THREAT = 1,
    BLIP_NONE = 0,
